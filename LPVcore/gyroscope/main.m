...
plot_ = true;
[data_est, data_val, Ts] = load_dataset();
plot_data(plot_, data_est, data_val)
...
arx_model = lpvarx(data_est, template_arx);
[rms_est, rms_val] = rms_computation(data_est, data_val, arx_model, plot_)
...
oe_model = lpvoe(data_est, template_oe, options_oe);
[rms_est, rms_val] = rms_computation(data_est, data_val, oe_model, plot_)
...
%ss_model = lpvssest(data_est, template_ss, options_pem_ss);
%[rms_est, rms_val] = rms_computation(data_est, data_val, ss_model, plot_)
